...
async function ViewDataCreate(InputData) {
    ...
    if (exist2 == false){
        ...
        if (exist == false){ //세션 단위로 수치가 올라갈 것들은 이 아래에
            ...
            if (InputData.gender == true){
                NewNumeric.male+=1;
                if (InputData.age < 20){NewNumeric.ageM10+=1;}
                else if (InputData.age <25){NewNumeric.ageM2024+=1;}
                else if (InputData.age <30){NewNumeric.ageM2529+=1;}
                else if (InputData.age <35){NewNumeric.ageM3034+=1;}
                else if (InputData.age <40){NewNumeric.ageM3539+=1;}
                else if (InputData.age <45){NewNumeric.ageM4044+=1;}
                else if (InputData.age <50){NewNumeric.ageM4549+=1;}
                else if (InputData.age <55){NewNumeric.ageM5054+=1;}
                else if (InputData.age <60){NewNumeric.ageM5559+=1;}
                else {NewNumeric.ageM60+=1;}
            }
            if (InputData.gender == false){
                NewNumeric.female+=1;
                if (InputData.age < 20){NewNumeric.ageW10+=1;}
                else if (InputData.age <25){NewNumeric.ageW2024+=1;}
                else if (InputData.age <30){NewNumeric.ageW2529+=1;}
                else if (InputData.age <35){NewNumeric.ageW3034+=1;}
                else if (InputData.age <40){NewNumeric.ageW3539+=1;}
                else if (InputData.age <45){NewNumeric.ageW4044+=1;}
                else if (InputData.age <50){NewNumeric.ageW4549+=1;}
                else if (InputData.age <55){NewNumeric.ageW5054+=1;}
                else if (InputData.age <60){NewNumeric.ageW5559+=1;}
                else {NewNumeric.ageW60+=1;}
            }

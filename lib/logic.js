...
async function ViewDataCreate(InputData) {
    ...
    const newView = factory.newResource(NS, "ViewData",InputData.sid.slice(0,4)+"-"+String(Timenow));
    ...
    //     return UserRegistry.exists(InputData.sid);
    // })
    ...
    //         newUser.channels = [InputData.channel];
    //         newUser.timestamp = InputData.timestamp;
    //         const participantRegistry = getParticipantRegistry(NS+".User");
